            ...
            with open("Details\Details.csv", 'r') as csvFile2:
                ...
                for lines in reader1:
                    if (str(lines[0]) == rfid):
                        ...
                        print(attendance)
                        result = requests.post(firebase_url + '/' + "DKTE" + '/entryin.json', data=json.dumps(attendance))
...
message3 = tk.Label(window, text="RFID Based IN Entry System" ,fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
message3.place(x=10, y=10)
...
head1 = tk.Label(frame1, text="**** IN ENTRY SCREEN ****", fg="white",bg="blue" ,height=1,width=69,font=('times', 18, ' bold ') )
head1.place(x=0,y=0)
...
lbl3 = tk.Label(frame1, text="--------------- IN ENTRY ATTENDANCE ----------------",width=50  ,fg="black"  ,bg="#00aeff" ,font=('times', 15, ' bold '))
